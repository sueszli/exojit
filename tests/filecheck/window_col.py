...
# CHECK-NEXT:   llvm.func @set_col(%offset_pointer: !llvm.ptr) {
...
# CHECK-NEXT:   }
# CHECK-NEXT:   llvm.func @window_col(%offset_pointer_4: !llvm.ptr) {
...
# CHECK-NEXT:     %increment = llvm.mul %c4, %12 : i64
# CHECK-NEXT:     %subview = llvm.add %increment, %10 : i64
...
# CHECK-NEXT:     llvm.call @set_col(%offset_pointer_7) : (!llvm.ptr) -> ()
