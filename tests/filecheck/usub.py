...
# CHECK-NEXT:   llvm.func @usub_float(%0: !llvm.ptr {llvm.noalias}, %1: !llvm.ptr {llvm.noalias}) {
...
# CHECK-NEXT:   }
# CHECK-NEXT:   llvm.func @usub_int(%9: !llvm.ptr {llvm.noalias}, %10: !llvm.ptr {llvm.noalias}) {
