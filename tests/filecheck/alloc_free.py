...
# CHECK-NEXT:   %3 = arith.constant 4 : i64
# CHECK-NEXT:   cf.br ^bb0(%1 : i64)
# CHECK-NEXT: ^bb0(%4 : i64):
# CHECK-NEXT:   %5 = arith.cmpi slt, %4, %0 : i64
# CHECK-NEXT:   cf.cond_br %5, ^bb1, ^bb2
# CHECK-NEXT: ^bb1:
# CHECK-NEXT:   %offset_pointer_1 = "llvm.call"(%3) <{callee = @malloc, fastmathFlags = #llvm.fastmath<none>, CConv = #llvm.cconv<ccc>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, TailCallKind = #llvm.tailcallkind<none>}> : (i64) -> !llvm.ptr
# CHECK-NEXT:   %6 = arith.index_cast %4 : i64 to index
...
# CHECK-NEXT:   %10 = arith.addi %4, %2 : i64
