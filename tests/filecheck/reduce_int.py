...
# CHECK-NEXT:   llvm.func @reduce_int(%offset_pointer: !llvm.ptr, %offset_pointer_1: !llvm.ptr) {
...
# CHECK-NEXT:     %6 = llvm.load %offset_pointer_4 : !llvm.ptr -> i32
...
# CHECK-NEXT:     %7 = llvm.load %offset_pointer_7 : !llvm.ptr -> i32
# CHECK-NEXT:     %8 = llvm.add %7, %6 : i32
...
# CHECK-NEXT:     llvm.store %8, %offset_pointer_10 : i32, !llvm.ptr
