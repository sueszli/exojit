...
# CHECK-NEXT:   %3 = arith.cmpi slt, %2, %0 : i64
# CHECK-NEXT:   cf.cond_br %3, ^bb1, ^bb2
# CHECK-NEXT: ^bb1:
# CHECK-NEXT:   %4 = arith.constant 1 : i64
# CHECK-NEXT:   %offset_pointer_1 = "llvm.call"(%4) <{callee = @malloc, fastmathFlags = #llvm.fastmath<none>, CConv = #llvm.cconv<ccc>, op_bundle_sizes = array<i32>, operandSegmentSizes = array<i32: 1, 0>, TailCallKind = #llvm.tailcallkind<none>}> : (i64) -> !llvm.ptr
# CHECK-NEXT:   %5 = arith.index_cast %2 : i64 to index
# CHECK-NEXT:   %bytes_per_element = arith.constant 4 : index
# CHECK-NEXT:   %scaled_pointer_offset = arith.muli %5, %bytes_per_element : index
...
# CHECK-NEXT:   %6 = "llvm.load"(%offset_pointer_5) <{ordering = 0 : i64}> : (!llvm.ptr) -> f32
# CHECK-NEXT:   %7 = arith.index_cast %c0 : i64 to index
# CHECK-NEXT:   %bytes_per_element_1 = arith.constant 4 : index
# CHECK-NEXT:   %scaled_pointer_offset_1 = arith.muli %7, %bytes_per_element_1 : index
...
# CHECK-NEXT:   "llvm.store"(%6, %offset_pointer_9) <{ordering = 0 : i64}> : (f32, !llvm.ptr) -> ()
# CHECK-NEXT:   %8 = arith.index_cast %c0 : i64 to index
...
# CHECK-NEXT:   %10 = arith.index_cast %2 : i64 to index
# CHECK-NEXT:   %bytes_per_element_3 = arith.constant 4 : index
# CHECK-NEXT:   %scaled_pointer_offset_3 = arith.muli %10, %bytes_per_element_3 : index
...
# CHECK-NEXT:   %11 = arith.addi %2, %1 : i64
